export const translations = {
  ko: {
    ...
    createLinkedNote: (name: string) => `새 노트 만들기: ${name}`,
    createLinkedNoteError: '노트를 만들지 못했습니다. 폴더 권한을 확인하고 다시 시도해 주세요.',
  ...
  en: {
    ...
    createLinkedNote: (name: string) => `Create note: ${name}`,
    createLinkedNoteError: 'Could not create the note. Check folder permissions and try again.',
